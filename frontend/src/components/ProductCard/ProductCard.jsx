...
const ProductCard = memo(function ProductCard({
  ...
  return (
    ...
    >
      ...
      {shareOpen && (
        // The URL, the message and the price now come from utils/share.js, so
        // a listing shared from a card and the same listing shared from its
        // product page read identically.
